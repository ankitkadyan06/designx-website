  ...
  return (
    ...
    <div className="px-[15px] sm:px-[50px] lg:px-[80px]">
      ...
      <p className="text-[14px] sm:text-[16px] lg:text-[18px] text-[#C8C8C8] font-normal">
        ...
        advertising partners of DesignX.
      </p>
      <p className="text-[14px] sm:text-[16px] lg:text-[18px] text-[#C8C8C8] font-normal">
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on DesignX, which are sent directly
      ...
      <p className="text-[14px] sm:text-[16px] lg:text-[18px] text-[#C8C8C8] font-normal">
        Note that DesignX has no access to or control over these cookies that
