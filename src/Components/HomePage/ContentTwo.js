  ...
  return (
    <div className="tiltBGHomepage">
      <div className="backContTwo pt-[50px]">
        <p data-aos="fade-up" className="mobileFactory text-white text-[22px] sm:text-[28px] lg:text-[32px] font-poppins font-medium capitalize block lg:hidden">
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-0 lg:gap-4 px-[15px] sm:px-[30px] md:px-[50px] 2xl:px-[80px] pt-[50px] lg:pt-[100px] pb-[30px] lg:pb-[30px]">
          <div className="mt-[0px] lg:mt-[20px] overlook">
            <p data-aos="fade-up" className="text-white text-[28px] md:text-[32px] lg:text-[36px] font-poppins font-medium capitalize tracking-wide lg:block hidden">
              One Factory-One Platform
            </p>
            <p data-aos="fade-up" className="text-[#D4D4D4] text-[12px] tracking-wide sm:text-[14px] md:text-[18px] lg:text-[20px] font-poppins leading-[20px] lg:leading-[30px] xl:leading-[36px]">
            ...
            <p data-aos="fade-up" className="text-[#D4D4D4] text-[12px] sm:text-[14px] md:text-[18px] lg:text-[20px] tracking-wide font-poppins leading-[20px] lg:leading-[30px] xl:leading-[36px]">
            ...
            <Link to="/Product">
              <button data-aos="fade-up" className="bg-white text-[#001141] text-[12px] sm:text-[14px] md:text-[18px] p-[10px] rounded-[5px] font-poppins font-medium">
                Know More
              </button>
            </Link>
          </div>
