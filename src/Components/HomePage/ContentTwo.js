...
const ContentTwo = () => {
  return (
    ...
    <p className="mobileFactory text-white text-[16px] sm:text-[28px] lg:text-[32px] font-poppins font-medium capitalize block lg:hidden">One Factory-One Platform</p>
      <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-4 px-[15px] sm:px-[30px] md:px-[50px] 2xl:px-[80px] pt-[50px] lg:pt-[100px] pb-[30px] lg:pb-[30px]">
        <div className="mt-[0px] lg:mt-[20px] overlook">
          ...
          <p className="text-[#D4D4D4] text-[12px] tracking-wide sm:text-[14px] md:text-[18px] lg:text-[20px] font-poppins leading-[36px]">
          ...
          <p className="text-[#D4D4D4] text-[12px] sm:text-[14px] md:text-[18px] lg:text-[20px] tracking-wide font-poppins leading-[36px]">
          ...
          <p className="text-[#D4D4D4] text-[12px] sm:text-[14px] md:text-[18px] lg:text-[20px] tracking-wide font-poppins leading-[36px] lg:w-[80%]">
