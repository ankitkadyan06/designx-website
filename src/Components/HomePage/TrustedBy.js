...
const TrustedBy = () => {
  return (
    <div className="trustedBy">
      <p className="text-gradientTrust text-[28px] lg:text-[38px] font-poppins block lg:hidden pt-[50px] pl-[30px] font-medium">
        Trusted by
      </p>
      <hr className="w-[20%] border-[3px] border-solid border-[#0049FF] relative bottom-[17px] block lg:hidden left-[30px]" />
      <p className="text-[20px] sm:text-[28px] lg:text-[32px] text-white font-poppins font-medium pl-[30px] block lg:hidden">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 pt-[50px] lg:pt-[100px] pb-[20px] px-[30px] lg:px-[80px]">
        ...
        <div className="px-[0px] lg:px-[10px]">
          ...
          <p className="text-[14px] lg:text-[18px] text-white font-poppins font-light">
          ...
          <Link to="/Contact">
            <button className="bg-white text-[#001141] text-[14px] lg:text-[18px] p-[10px] rounded-[5px] font-poppins font-medium">
              Learn More
            </button>
          </Link>
        </div>
