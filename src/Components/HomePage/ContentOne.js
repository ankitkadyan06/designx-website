...
const ContentOne = () => {
  return (
    ...
    <div className='backContent h-[950px] lg:h-[800px]'>
      <div className='flex flex-col lg:grid lg:grid-cols-2 gap-4 pt-[30px] lg:pt-[100px] px-[30px] xl:px-[80px]'>
        ...
        <div className=''>
          <img src={dashboard} alt="" className='px-[10px] lg:px-[50px] relative z-[10]'/>
          <img src={spring} alt="" className='absolute top-[72rem] right-[1px] z-[1] hidden lg:block' />
        </div>
      </div>
    </div>
    </div>
