...
const ContentOne = () => {
  return (
    <div>
    <div className='backContent h-[950px] lg:h-[800px]'>
    <p className='text-white text-[20px] sm:text-[28px] lg:text-[32px] font-poppins capitalize pt-[50px] px-[30px] xl:px-[80px] block lg:hidden'>Massive volume of manufacturing data is Overlooked</p>
      <div className='flex flex-col-reverse lg:grid lg:grid-cols-2 gap-4 pt-[30px] lg:pt-[100px] px-[30px] xl:px-[80px]'>
