...
const Approach = () => {
  return (
    <div className='px-[10px] lg:px-[30px] py-[30px] Approach'>
      <p className='text-white text-[36px] lg:text-[46px] font-poppins font-medium underline underline-offset-[16px] decoration-[#0088FF]'>Our Approch</p>
