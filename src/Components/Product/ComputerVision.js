...
const ComputerVision = () => {
  return (
    <div className="tiltBGProduct">
      <div className="IIOT py-[50px] lg:py-[100px] px-[30px] lg:px-[80px]">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 pt-[50px] lg:pt-[100px]">
          <div className="px-[10px] overlook">
            <p className="text-white text-[24px] lg:text-[28px] font-poppins font-medium capitalize">
              Computer Vision
            </p>
            <p className="text-[#C8C8C8] text-[14px] lg:text-[18px] font-poppins text-justify hidden lg:block">
            ...
            <Link to="/BlogDetails" className="no-underline hidden lg:block">
              <button className="blogReadButton flex items-center justify-around w-[151px] h-[40px] rounded-[7px] font-inter font-normal text-white">
