...
const ProductIIOT = () => {
  return (
    ...
    <div className="IIOT py-[40px] lg:py-[100px] px-[30px] lg:px-[80px]">
    <p className="iiotDetails text-white text-[20px] md:text-[24px] lg:text-[28px] font-poppins font-medium capitalize block lg:hidden">IIOT</p>
      <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-4 pt-[0px] md:pt-[50px] lg:pt-[100px]">
        <div className="px-[10px] overlook">
          ...
          <Link to="/BlogDetails" className='no-underline'><button className='blogReadButton flex text-[14px] items-center justify-around w-[151px] h-[40px] rounded-[7px] font-inter font-normal text-white'>Read More <img src={readMoreArrow} alt="" /></button></Link>
        </div>
