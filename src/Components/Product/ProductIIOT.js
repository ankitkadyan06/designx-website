  ...
  return (
    <div className="tiltBGProduct">
      <div className="IIOT py-[30px] sm:py-[40px] lg:py-[100px] px-[15px] sm:px-[30px] lg:px-[80px]">
        <p data-aos="fade-up" className="iiotDetails text-white text-[22px] md:text-[24px] lg:text-[28px] font-poppins font-medium capitalize block lg:hidden">
          IOT
        </p>
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-4 pt-[0px] md:pt-[50px] lg:pt-[100px]">
          <div className=" pr-[0px] md:pr-[50px] lg:pr-[80px] overlook">
            <p data-aos="fade-up" className="text-white text-[24px] lg:text-[28px] xl:text-[32px] font-poppins font-medium capitalize hidden lg:block">
              IOT
            </p>
            <p data-aos="fade-up" className="text-[#C8C8C8] text-[12px] sm:text-[14px] lg:text-[18px] font-poppins tracking-wide leading-[20px] lg:leading-[30px] xl:leading-[36px]">
            ...
            <Link to="/IOTGateway" className="no-underline" data-aos="fade-up">
          ...
          <div className="checkImage flex justify-center lg:justify-start pl-[0px]">
            <img src={IIOTMachine} alt="" className="" data-aos="fade-up" />
          </div>
        </div>
      </div>
    </div>
