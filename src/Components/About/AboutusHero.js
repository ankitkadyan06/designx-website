...
const AboutusHero = () => {
  return (
    <div className="heroAbout pt-[70px] h-[100%] pb-[50px]">
      <p className="text-[43px] text-white font-poppins w-[50%] mt-[15%] ml-[50%]">
      Streamline the manufacturing process to build next generation shop floors
      </p>
      <p className="mt-[238px] ml-[85px] text-[32px] text-white font-poppins font-medium underline underline-offset-8">
        Trusted By
      </p>
      <Marquee>
