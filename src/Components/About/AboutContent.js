    ...
    <div className="aboutContent pb-[60px] pt-[1px] lg:pt-[0px]">
      <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4">
        <div className="mx-[30px] lg:mx-[80px] mt-[50px] text-justify relative z-[2]">
          ...
          <p className="text-[14px] lg:text-[18px] text-[#adadad] font-poppins hidden lg:block">
        ...
        <div className="flex justify-center mx-[30px]">
          <img
            src={checkImage}
            alt=""
        ...
        <div className="mx-[30px] block lg:hidden">
        ...
        <p className="text-[20px] md:text-[28px] lg:text-[32px] text-white font-poppins font-medium mx-[30px] block lg:hidden">
            Switch to Smart Shopfloors with DFOS
          </p>
        <div className="flex justify-center">
          <img src={shop} alt="" className="mt-[0px] lg:mt-[0px]" />
        </div>
        <div className="mx-[30px] lg:mx-[50px] mt-[0px] lg:mt-[70px] text-justify">
