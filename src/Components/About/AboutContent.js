  ...
  return (
    <div className="aboutContent pb-[60px]">
      <div className="grid grid-cols-2 gap-4">
        <div className="ml-[80px] mt-[150px] mr-[142px] text-justify relative z-[2]">
        ...
        <div>
            <img src={checkImage} alt="" className="relative z-[2]" />
            <img src={spring} alt="" className='absolute top-[65rem] right-0 ' />
        </div>
