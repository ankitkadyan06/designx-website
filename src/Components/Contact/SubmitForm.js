...
const SubmitForm = () => {
  return (
    <div className="pt-[150px]">
      <div className="block md:grid md:grid-cols-2 gap-4 mx-[30px] lg:mx-[80px]">
        <div className="w-full lg:w-[390px]">
          <p className="text-white text-[20px] md:text-[36px] lg:text-[47px] font-poppins font-semibold">
          ...
          <div className="flex flex-row mt-[40px]">
            <div className="bookDemo w-[130px] lg:w-[168px] h-[172px] lg:h-[202px] cursor-pointer focus:border-[5px] focus:border-solid focus:border-[#0046FF]">
            ...
            <div className="bookDemo ml-[40px] w-[130px] lg:w-[168px] h-[172px] lg:h-[202px] cursor-pointer focus:border-[5px] focus:border-solid focus:border-[#0046FF]">
        ...
        <div className="formBackground ml-[10%] sm:ml-[30%] mt-[20px] lg:mt-[0px] lg:ml-[70px] w-[300px] lg:w-[414px]">
